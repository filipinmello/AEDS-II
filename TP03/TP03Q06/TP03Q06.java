...
public class TP03Q06 {
    ...
    static class Pilha {
        ...
        public void push(Personagem x) {
            ultimo.prox = new Celula(x);
            ultimo = ultimo.prox;
        }

        public Personagem pull(){
            if (primeiro == ultimo) {
        ...
        private int mostrar(Celula i, int x) {
            if (i != null) {
                x = mostrar(i.prox, x);
                System.out.print("[" + x + " ## ");
                i.elemento.imprimir();
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if(values[0].equals("I")){
                pilha.push(personagens.buscarPersonagem(values[1]));
            }else if(values[0].equals("R")){
                System.out.println("(R) " + pilha.pull().getName());
            }
        }
