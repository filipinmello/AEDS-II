...
public class TP03Q11 {
    ...
    public void quickSort() {
        if (primeiro.prox != null) {
            System.out.println(primeiro.prox.elemento.getName());
            System.out.println(ultimo.elemento.getName());
    ...
    private void quickSortRec(Celula esq, Celula dir) {
        if (esq != dir) {
            System.out.println(esq.elemento.getName());
    ...
    private int compare(Personagem p1, Personagem p2) {
        ...
        int houseComparison = p1.house.compareTo(p2.house);
    ...
    private void swap(Celula c1, Celula c2) {
        Personagem temp = c1.elemento;
